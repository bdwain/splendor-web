...
gulp.task('default', 'Start a server and run js/css build watchers and test watchers', 
  ['clean', 'js:watch', 'css:watch', 'server'], null, {aliases: ['run', 'start']});

gulp.task('debug', 'Same as the default task, but uses chrome as the test browser so you can use the js debugger', 
  ['clean', 'js:watch:debug', 'css:watch', 'server']);
